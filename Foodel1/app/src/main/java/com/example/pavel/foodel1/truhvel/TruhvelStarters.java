...
public class TruhvelStarters extends AppCompatActivity implements View.OnClickListener, RestaurantCourse {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Trühvel: Starters");

        setContentView(R.layout.truhvel_starters);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.buttonStartersTruhvelPay:
                selectCourse();
                ...
                break;
            case R.id.buttonStartersTruhvelMain:
                selectCourse();
                ...
                startActivity(main);
                break;
            case R.id.buttonStartersTruhvelDessert:
                selectCourse();
                Intent starters = new Intent(this, TruhvelDesserts.class);
    ...
    @Override
    public void setId() {
        starter1 = (CheckBox)findViewById(R.id.truhvelStarter1);
        starter2 = (CheckBox)findViewById(R.id.truhvelStarter2);
        starter3 = (CheckBox)findViewById(R.id.truhvelStarter3);
        starter4 = (CheckBox)findViewById(R.id.truhvelStarter4);
        starter5 = (CheckBox)findViewById(R.id.truhvelStarter5);
        starter6 = (CheckBox)findViewById(R.id.truhvelStarter6);
        starter7 = (CheckBox)findViewById(R.id.truhvelStarter7);
        starter8 = (CheckBox)findViewById(R.id.truhvelStarter8);
        starter9 = (CheckBox)findViewById(R.id.truhvelStarter9);
        starter10 = (CheckBox)findViewById(R.id.truhvelStarter10);
        pay = (Button)findViewById(R.id.buttonStartersTruhvelPay);
        dessert = (Button)findViewById(R.id.buttonStartersTruhvelDessert);
        mainCourse = (Button)findViewById(R.id.buttonStartersTruhvelMain);
