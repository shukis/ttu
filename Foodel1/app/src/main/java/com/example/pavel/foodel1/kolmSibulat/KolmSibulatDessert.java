...
public class KolmSibulatDessert extends AppCompatActivity implements View.OnClickListener, RestaurantCourse {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("CKolm Sibulat: Desserts");

        setContentView(R.layout.kolm_sibulat_dessert);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.buttonDessertKolmSibulatPay:
                selectCourse();
                ...
                break;
            case R.id.buttonDessertKolmSibulatMain:
                selectCourse();
                ...
                startActivity(main);
                break;
            case R.id.buttonDessertKolmSibulatStarters:
                selectCourse();
    ...
    @Override
    public void setId() {
        des1 = (CheckBox)findViewById(R.id.kolmSibulatDesserts1);
        des2 = (CheckBox)findViewById(R.id.kolmSibulatDesserts2);
        des3 = (CheckBox)findViewById(R.id.kolmSibulatDesserts3);
        des4 = (CheckBox)findViewById(R.id.kolmSibulatDesserts4);

        pay = (Button)findViewById(R.id.buttonDessertKolmSibulatPay);
        mainCourse = (Button)findViewById(R.id.buttonDessertKolmSibulatMain);
        starters = (Button)findViewById(R.id.buttonDessertKolmSibulatStarters);
    }
