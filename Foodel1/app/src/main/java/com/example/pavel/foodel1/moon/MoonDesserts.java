...
public class MoonDesserts extends AppCompatActivity implements View.OnClickListener, RestaurantCourse {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Moon: Desserts");

        setContentView(R.layout.moon_desserts);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.buttonDessertMoonPay:
                selectCourse();
                ...
                break;
            case R.id.buttonDessertMoonMain:
                selectCourse();
                ...
                startActivity(main);
                break;
            case R.id.buttonDessertMoonStarters:
                selectCourse();
    ...
    public void setId() {
        ...
        des1 = (CheckBox)findViewById(R.id.moonDesserts1);
        des2 = (CheckBox)findViewById(R.id.moonDesserts2);
        des3 = (CheckBox)findViewById(R.id.moonDesserts3);
        des4 = (CheckBox)findViewById(R.id.moonDesserts4);
        pay = (Button)findViewById(R.id.buttonDessertMoonPay);
        mainCourse = (Button)findViewById(R.id.buttonDessertMoonMain);
        starters = (Button)findViewById(R.id.buttonDessertMoonStarters);
